...
async function main() {
    ...
    console.log("Account balance:", hre.ethers.formatEther(await hre.ethers.provider.getBalance(deployer.address)), "ETH/POL");
    ...
    const TOKEN_CONFIG = {
        ...
        mintPrice: process.env.MINT_PRICE || hre.ethers.parseEther("0.1"),      // 0.1 POL
    ...
    console.log("  Mint Price:", hre.ethers.formatEther(TOKEN_CONFIG.mintPrice), "ETH/POL");
    ...
    console.log("  Mint Price:", hre.ethers.formatEther(mintPrice), "ETH/POL");
    ...
    console.log("\n3. Test public mint:");
    console.log(`   await token.publicMint({ value: ethers.parseEther("0.1") })`);
