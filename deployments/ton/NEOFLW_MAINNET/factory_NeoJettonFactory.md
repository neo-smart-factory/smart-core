...
graph TD
NeoJettonFactory
NeoJettonFactory --> BaseTrait
NeoJettonFactory --> Ownable
Ownable --> BaseTrait
NeoJettonFactory --> Deployable
...
graph TD
NeoJettonFactory
NeoJettonFactory --> NeoJettonMinter
NeoJettonMinter --> NeoJettonWallet
NeoJettonFactory --> NeoJettonWallet
```