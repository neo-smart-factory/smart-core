...
async function verifyDeployment() {
    ...
    const endpoint = isTestnet
        ? (apiKey ? `https://testnet.toncenter.com/api/v2/jsonRPC?api_key=${apiKey}` : 'https://testnet.toncenter.com/api/v2/jsonRPC')
        : (apiKey ? `https://toncenter.com/api/v2/jsonRPC?api_key=${apiKey}` : 'https://toncenter.com/api/v2/jsonRPC');
