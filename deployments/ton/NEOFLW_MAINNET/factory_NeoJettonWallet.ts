...
export function dictValueParserNeoJettonFactory$Data(): DictionaryValue<NeoJettonFactory$Data> {
 ...
 type NeoJettonWallet_init_args = {
    $$type: 'NeoJettonWallet_init_args';
    owner: Address;
    master: Address;
}

function initNeoJettonWallet_init_args(src: NeoJettonWallet_init_args) {
    return (builder: Builder) => {
        const b_0 = builder;
        b_0.storeAddress(src.owner);
        b_0.storeAddress(src.master);
...
async function NeoJettonWallet_init(owner: Address, master: Address) {
    const __code = Cell.fromHex('');
    const builder = beginCell();
    builder.storeUint(0, 1);
    initNeoJettonWallet_init_args({ $$type: 'NeoJettonWallet_init_args', owner, master })(builder);
    const __data = builder.endCell();
    return { code: __code, data: __data };
}

export const NeoJettonWallet_errors = {
...
export const NeoJettonWallet_errors_backward = {
    "Stack underflow": 2,
    "Stack overflow": 3,
    "Integer overflow": 4,
...
const NeoJettonWallet_types: ABIType[] = [
...
const NeoJettonWallet_getters: ABIGetter[] = [
...
export const NeoJettonWallet_getterMapping: { [key: string]: string } = {
    'balance': 'getBalance',
    'owner': 'getOwner',
    'master': 'getMaster',
...
export class NeoJettonWallet implements Contract {
    
    public static readonly storageReserve = 0n;
    public static readonly errors = NeoJettonWallet_errors_backward;
    public static readonly opcodes = NeoJettonWallet_opcodes;
    
    static async init(owner: Address, master: Address) {
        return await NeoJettonWallet_init(owner, master);
    }
    
    static async fromInit(owner: Address, master: Address) {
        const __gen_init = await NeoJettonWallet_init(owner, master);
        const address = contractAddress(0, __gen_init);
        return new NeoJettonWallet(address, __gen_init);
    }
    
    static fromAddress(address: Address) {
        return new NeoJettonWallet(address);
    }
    
    readonly address: Address; 
    readonly init?: { code: Cell, data: Cell };
    readonly abi: ContractABI = {
        types:  NeoJettonWallet_types,
        getters: NeoJettonWallet_getters,
        receivers: NeoJettonWallet_receivers,
        errors: NeoJettonWallet_errors,
    };
    ...
    async send(provider: ContractProvider, via: Sender, args: { value: bigint, bounce?: boolean| null | undefined }, message: InternalTransfer | Transfer | SetWalletPause | Burn) {
        ...
        if (message && typeof message === 'object' && !(message instanceof Slice) && message.$$type === 'SetWalletPause') {
            body = beginCell().store(storeSetWalletPause(message)).endCell();
        }
